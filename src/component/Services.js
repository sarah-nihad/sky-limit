...
<div className='imgBox'> <img src={require('../img/vision.jpg')}  alt='img' />   </div>
...
<div className='imgBox' > <img src={require('../img/customize.jpg')}  alt='img' />   </div>
...
<div  className='details' >
   ...
   <div style={{padding:'10px'}} id='concepttext' >We can add or customized any requirements to help your organization</div>
    ...
    <div className='imgBox'> <img src={require('../img/Advisory.jpg')}  alt='img' />   </div>
    <div className='details' >
...
,paddingTop:'4%',paddingBottom:'5%'}}>
    ...
    {/* <div  id='divcolss'> */}  <div className='card'>
                           
    <div className='imgBox'> <img src={require('../img/Coustomer service.jpg')}  alt='img' />   </div>
   <div  className='details' >
    ...
    <Col lg={4} id='colomnservices1'>
     ...
     <div className='imgBox'> <img src={require('../img/training.jpg')} alt='img' />   </div>
     <div  className='details'>
    ...
    <div className='imgBox'> <img src={require('../img/update.jpg')}  alt='img' />   </div>
